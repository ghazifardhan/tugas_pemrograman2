 ...
 * @author markibid
 */
public class DaftarCategoryOutcomeView extends javax.swing.JInternalFrame {

    /**
     * Creates new form DaftarCategoryOutcomeView
     */
    DefaultTableModel model = new DefaultTableModel();
    String tableName = "category";
    Integer id = 0;
    public DaftarCategoryOutcomeView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Daftar Category Outcome");
